        ...
        <table width="540" cellpadding="0" cellspacing="0" border="0"
          ...
          <tr>
            <td align="center" style="padding:36px 40px 24px;">
              <p style="margin:0; font-size:20px; font-weight:bold; color:#1e40af; letter-spacing:0.5px;">HERITAGE &amp; HEARTH</p>
              <p style="margin:6px 0 0; font-size:12px; color:#64748b; letter-spacing:1px; text-transform:uppercase;">Account Verification</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 40px;">
              ...
              <p style="margin:0 0 28px; font-size:14px; color:#4a5568; line-height:1.7;">
                We received a request to verify your Heritage & Hearth account.
                Please use the code below to complete your verification.
                This code will expire in <strong style="color:#1e40af;">10 minutes</strong>.
              </p>
                ...
                <tr>
                  <td align="center">
                    <table cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td align="center"
                          style="background-color:#eff6ff; border:1px solid #bfdbfe; border-radius:6px; padding:20px 40px;">
                          <p style="margin:0 0 6px; font-size:11px; font-weight:bold; color:#3b82f6; letter-spacing:1.5px; text-transform:uppercase;">Verification Code</p>
                          <p style="margin:0; font-size:38px; font-weight:bold; color:#1e3a8a; letter-spacing:10px; font-family:'Courier New', Courier, monospace;">${otp}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td style="background-color:#f8fafc; border-top:1px solid #e2e8f0; padding:20px 40px; text-align:center;">
              <p style="margin:0 0 4px; font-size:12px; color:#64748b;">
                ...
                <a href="mailto:support@heritageandhearth.com" style="color:#2563eb; text-decoration:none;">support@heritageandhearth.com</a>
              </p>
